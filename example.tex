\documentclass{officialxam}
\highschool{វិទ្យាល័យសុខអានទន្លេបាទី}
\xam{សាកល្បងលើកទី១}
\grade{១២ ក}
\xamdate{២៧ សីហា ២០២៤}
\subject{គណិតវិទ្យា}
\minute{១២០}
\score{១២៥}
\SetWatermarkText{\color{magenta!67!red} រៀបរៀងដោយ \sffamily អូល សាយ}
\begin{document}
  \borderline{សំណួរ}
  \begin{enumerate}
    \item(១៥ ពិន្ទុ) គណនាលីមីត% (១៥ ពិន្ទុ)
    \begin{Enumerate}(3)
    ...
    \end{Enumerate}
    \item(១០ ពិន្ទុ) ក្នុងថ្នាក់រៀនមួយមានសិស្សពូកែ $ 10 $ នាក់ ដែលក្នុងនោះ $ 4 $ នាក់ជាសិស្សស្រីនិង $ 6 $ នាក់ជាសិស្សប្រុស។ គេរៀបចំសិស្សជាក្រុមក្នុងមួយក្រុមមានសិស្ស $ 4 $ នាក់ដោយចៃដន្យ យកទៅប្រកួតជាមួយក្រុមសិស្សថ្នាក់ដ៏ទៃ។ រកប្រូបាបនៃព្រឹត្តិការណ៍ខាងក្រោម៖% (១០ ពិន្ទុ)
    \begin{enumerate}
    ...
    \end{enumerate}
    \item(១៥ ពិន្ទុ) គេមានចំនួនកុំផ្លិច $ z_1=1+i\sqrt{3} $ និង $ z_2=6\left(\cos\dfrac{\pi}{4}+i\sin\dfrac{\pi}{4}\right) $% (១៥ ពិន្ទុ)
    \begin{enumerate}
      \item សរសេរ $ z_1 $ ជាទម្រង់ត្រីកោណមាត្រ។
      \item រកម៉ូឌុលនិងអាគុយម៉ង់ $ z_1^3 $~។
      \item សរសេរផលគុណ $ z_1\times z_2 $ ជាទម្រង់ពីជគណិត។
    \end{enumerate}
    \item(២៥ ពិន្ទុ)% (២៥ ពិន្ទុ)
    \begin{enumerate}
    ...
    \end{enumerate}
    \item(១៥ ពិន្ទុ) គណនាអាំងតេក្រាល $ I=\displaystyle\int_{1}^{3}\left(x-2+3x^3\right)\mathrm{d}x $; $ J=\displaystyle\int_{0}^{\frac{\pi}{4}}\left(\sin 2x-\cos x\right)\mathrm{d}x $; \\% (១៥ ពិន្ទុ)
    ...
    %
    \item(១០ ពិន្ទុ)% (១០ ពិន្ទុ)
    \begin{enumerate}
      \item ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែល $ (E): y''-3y'+2y=0 $~។
      \item រកចម្លើយពិសេសមួយនៃសមីការឌីផេរ៉ង់ស្យែល $ (E) $ ដែល $ y(0)=1 $ និង $ y'(1)=e^2 $~។
    \end{enumerate}
    %
    \item(៣៥ ពិន្ទុ) គេមានអនុគមន៍ $ f $ កំណត់លើ $ \mathbb{R} $ ដោយ $ f(x)=x+\dfrac{1-3e^x}{1+e^x} $~។ គេតាងដោយ $ C $ ក្រាបរបស់វានៅក្នុងប្លង់ប្រដាប់ដោយតម្រុយអរតូណរម៉ាល់ $ (0,\vec{i},\vec{j}) $~។% (៣៥ ពិន្ទុ)
    \begin{enumerate}
  ...
  \end{enumerate}
  \borderline{ចម្លើយ}\\
  \dotline{27} % បំពេញទំព័រទី២
  \newpage
  \dotline{39} % បំពេញទំព័រទី៣
  \newpage
  \dotline{39} % បំពេញទំព័រទី៤
%  អាចបូកសរុបបញ្ចូលគ្នាក៏បាន
\end{document}